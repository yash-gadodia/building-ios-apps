...
Seeded from **Parallax** (Expo + RN + Supabase). To start a new app: read `SKILL.md` → *Scaffolding a new app*.

> Keep this growing. The whole point is that knowledge compounds and rabbit holes don't repeat.
